...
log_info "  2. ./backend/env-to-ssm.sh ${ENVIRONMENT}"
log_info "  3. ./backend/deploy-backend.sh ${ENVIRONMENT}"
log_info "  4. ./frontend/deploy-frontend.sh ${ENVIRONMENT}"
command -v node >/dev/null 2>&1 || log_warn "node/npm not found on this machine — needed for steps 3 and 4 above."
log_info ""
